                ...
                <Table
                    ...
                    <Thead
                        ...
                        <Tr>
                            ...
                            <Th color={useColorModeValue('primary.800', 'primary.400')}>Idade</Th>
                            <Th color={useColorModeValue('primary.800', 'primary.400')}>Email</Th>
                    ...
                    <Tbody>
                        {users.map((user: User) =>  (
                            <Tr key={user._id}>
                                ...
                                <Td>{user.age}</Td>
                                <Td>{user.email}</Td>
                                <Td><NextLink href={"/users/" + user._id}>Editar</NextLink></Td>
                            </Tr>
                            )
                        )}
                    </Tbody>
